class ReportsController < ApplicationController
  ...
  #  @datasR = @operations.map{|el| 
  #  if(@data[:start_date]===el.created_at)
  # to_date.to_s
  #  @res = [el.amount.to_i ]}
  #  end
  #  @res
    # {"category_id"=>"1", "end_date"=>"2023-06-06", "operation_type"=>"expense", "start_date"=>"2023-06-01", 
    # "controller"=>"reports", "action"=>"report_by_dates"}
  end
